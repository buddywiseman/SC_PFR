...
contract PinkFreud is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x86F35E1846B463185fEcD73ae370130919270956); // Marketing Address
        
    address payable public teamAddress =
        payable(0x86F35E1846B463185fEcD73ae370130919270956); // Team Address
        
    address payable public liquidityAddress =
        payable(0x86F35E1846B463185fEcD73ae370130919270956); // Liquidity Address
    ...
    string private constant _symbol = "Pink Freud";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 4 / 10000; // 0.07%
